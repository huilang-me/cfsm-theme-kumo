...
const en: Dict = {
  ...
  errorRetry: "Retry",
  poweredBy: "Powered by CF-Server-Monitor.",
  version: "Version",
  bandwidth: "Bandwidth",
  ip: "IP",
  ...
  apply: "Apply",
  cancel: "Cancel",
  backgroundImageUrl: "Image host or video wallpaper URL",
  ...
  range12h: "12h",
  range24h: "24h",
  loginRequired: "Log in to view history longer than 1 hour",
  usage: "Usage",
  total: "Total",
  used: "Used",
  remaining: "Remaining",
  ...
  peak: "Peak",
  byNode: "By node",
  noOnlineNodes: "No online servers",
};
...
const zhCN: Dict = {
  ...
  range12h: "12 小时",
  range24h: "24 小时",
  loginRequired: "登录后可查看超过 1 小时的历史",
  usage: "使用率",
  total: "总计",
  used: "已用",
  remaining: "剩余",
